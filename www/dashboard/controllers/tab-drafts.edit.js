...
angular.module('core.dashboard')
	.controller('draftsEditCtrl', function ($stateParams, $state, $scope, $translate, $rootScope, forEditTask, offlineRepository) {
		var vm = this;
console.log('draftsEditCtrl');
		...
		vm.onSaveDraft = function() {
			offlineRepository.addDraft($stateParams.id, vm.data.formInfo, vm.data.model)
				.then(function() {
